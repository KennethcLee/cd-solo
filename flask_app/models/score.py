...
class Scores:
    ...
    def save_score(cls, data):
        print('***  4000  ***')
        query = "INSERT INTO scores(user_id, game_level_id, score, question_total, question_correct, created_at, updated_at) VALUES (%(user_id)s, %(game_level_id)s, %(score)s, %(question_total)s, %(question_correct)s, now(), now())"
        print('***  4000A  ***', query)
